...
namespace Wrox.ProCSharp.Arrays
{
    class Program
    {
        ...
        static void CreateUsingArrayClass()
        {
            ...
            Array personArray = Array.CreateInstance(typeof(Person), lengths, lowerBounds);
            personArray.SetValue(new Person("Alain", "Prost"), 1, 10);
            personArray.SetValue(new Person("Emerson", "Fittipaldi"), 1, 11);
            personArray.SetValue(new Person("Ayrton", "Senna"), 1, 12);
            personArray.SetValue(new Person("Ralf", "Schumacher"), 2, 10);
            personArray.SetValue(new Person("Fernando", "Alonso"), 2, 11);
            personArray.SetValue(new Person("Jenson", "Button"), 2, 12);

            Person[,] p2 = (Person[,])personArray;

            p2[1, 10] = new Person("x", "y");
            p2[1, 13] = new Person("a", "b");
